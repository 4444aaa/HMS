    ...
    <el-card class="box-card">
      ...
      >
        <el-form-item label="药品名称">
          <el-input
            v-model="searchForm.medicineName"
            placeholder="请输入药品名称"
            clearable
          />
        </el-form-item>
        <el-form-item label="药品编码">
          <el-input
            v-model="searchForm.medicineCode"
            placeholder="请输入药品编码"
            clearable
          />
        </el-form-item>
      ...
      >
        ...
        <el-table-column
          label="操作"
          :width="isMedicineReadOnly ? 100 : 220"
          fixed="right"
        >
          <template #default="scope">
            <el-button
      ...
      >
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            ...
            >
              <el-input
                v-model="medicineForm.medicineCode"
                placeholder="请输入药品编码"
              />
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          ...
          <el-col :span="12">
            ...
            >
              <el-select
                v-model="medicineForm.dosageForm"
                placeholder="请选择剂型"
                style="width: 100%"
              >
                <el-option
        ...
        <el-row :gutter="20">
          <el-col :span="12">
            ...
            >
              <el-select
                v-model="medicineForm.categoryId"
                placeholder="请选择分类"
                style="width: 100%"
              >
                <el-option
    ...
    >
      ...
      >
        <el-descriptions-item label="药品编码">
          {{ detailForm.medicineCode }}
        </el-descriptions-item>
        <el-descriptions-item label="药品名称">
          {{ detailForm.medicineName }}
        </el-descriptions-item>
        <el-descriptions-item label="规格">
          {{ detailForm.specification || '未设置' }}
        </el-descriptions-item>
      ...
      <!-- 库存调整 -->
      <div
        v-if="detailForm.id && !isMedicineReadOnly"
